...
var fullfilledTests = []struct {
	...
	// Regexp
	{"foobarwu", Condition{Regexp: regexp.MustCompile("[aeiou].")}, ``},
	{"foobarwu", Condition{Regexp: regexp.MustCompile("[aeiou]."), Count: 2}, ``},
	{"foobarwu", Condition{Regexp: regexp.MustCompile("[aeiou]."), Count: 3}, `Found 2 matches`},
	{"foobarwu", Condition{Regexp: regexp.MustCompile("[aeiou]."), Count: -1}, `Forbidden match`},
	{"frtgbwu", Condition{Regexp: regexp.MustCompile("[aeiou].")}, `Missing match`},
	// Min and Max
